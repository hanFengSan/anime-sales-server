...
public class DiscRank extends Entity {
    ...
    private int PT;
    private Date latestPullDate;  //上一次抓取时间
    ...
    public void update(DiscRank rank) {
        name = rank.getName();
        sName = rank.getsName();
        updateDate = rank.getUpdateDate();
        discType = rank.getDiscType();
        releaseDate = rank.getReleaseDate();
        amazonRank = rank.getAmazonRank();
        currentRank = rank.getCurrentRank();
        preRank = rank.getPreRank();
        preRank1 = rank.getPreRank1();
        preRank2 = rank.getPreRank2();
        preRank3 = rank.getPreRank3();
        preRank4 = rank.getPreRank4();
        preRank5 = rank.getPreRank5();
        PT = rank.getPT();
        latestPullDate = rank.getLatestPullDate();
        nicoOrder = rank.getNicoOrder();
        saleDay = rank.getSaleDay();
    }
